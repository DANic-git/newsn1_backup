...
#Путь к файлу логов
LOGFILE=/var/log/backup-weekly.log
...
FILE3='/backup/weekly/files_test'
#Путь до примонтированиого каталога FTP для файлов сайта
FTPDIRFILE='/mnt/temp-ftpfs/newsn1_backup/weekly/files'
#Путь до примонтированиого каталога FTP для дампов базы
FTPDIRSQL='/mnt/temp-ftpfs/newsn1_backup/weekly/sql'
#Путь до примонтированиого каталога FTP для файлов тестового сайта
FTPDIRFILETST='/mnt/temp-ftpfs/newsn1_backup/weekly/files_test'
